  ...
  return (
    <div>
      <div className="safety w-full max-w-6xl px-4 m-auto">
        <h1 className='uppercase text-center text-2xl sm:text-4xl md:text-5xl font-extrabold text-[var(--primary)] py-6 md:py-10'>Safety & Code Compliance</h1>
        ...
        <div className="content flex flex-col md:flex-row mt-8 md:mt-10 gap-6 md:gap-0">
          <div className="left w-full md:w-1/3 flex justify-center items-center mb-4 md:mb-0">
            <img className="w-full max-w-xs md:max-w-none" src="src/assets/service/safety.png" alt="" />
          </div>
          <div className="right w-full md:w-2/3 flex flex-col gap-5 md:ml-10">
            <h2 className='text-lg sm:text-xl md:text-2xl font-bold text-[var(--primary)]'>Critical Safety Services:</h2>
        ...
        <div className="bottom text-center mt-8 md:mt-10">
          <p className='text-base sm:text-xl md:text-2xl font-semibold w-full md:w-[60vw] m-auto text-[var(--primary)]'>"Our violation correction rate: 100% first-pass approval with NYC Department of Buildings."</p>
          <Link to="/contact" className="inline-flex items-center bg-[var(--primary)] font-bold text-base md:text-[20px] text-white border-0 py-2 px-6 md:px-9 focus:outline-none hover:bg-red-900 rounded-lg mt-4 md:mt-4">Request Code Compliance Audit</Link>
        </div>
      ...
      <div className="troubleshooting w-full max-w-6xl px-4 m-auto">
        <h1 className='uppercase text-center text-2xl sm:text-4xl md:text-5xl font-extrabold text-[var(--primary)] py-6 md:py-10'>Troubleshooting & Repairs&nbsp;</h1>
        ...
        <div className="content flex flex-col md:flex-row mt-8 md:mt-10 gap-6 md:gap-0">
          <div className="left w-full md:w-1/3 flex justify-center items-center mb-4 md:mb-0">
            <img className="w-full max-w-xs md:max-w-none" src="src/assets/service/troubleshooting.png" alt="" />
          </div>
          <div className="right w-full md:w-2/3 flex flex-col gap-5 md:ml-10">
            <h2 className='text-lg sm:text-xl md:text-2xl font-bold text-[var(--primary)]'>Immediate Repair Needs:</h2>
            <ul className='text-base sm:text-xl md:text-2xl font-semibold'>
        ...
        <div className="bottom text-center mt-8 md:mt-10">
          <p className='text-base sm:text-xl md:text-2xl font-semibold w-full md:w-[60vw] m-auto text-[var(--primary)]'>"Our violation correction rate: 100% first-pass approval with NYC Department of Buildings."</p>
          <Link to="/contact" className="inline-flex items-center bg-[var(--primary)] font-bold text-base md:text-[20px] text-white border-0 py-2 px-6 md:px-9 focus:outline-none hover:bg-red-900 rounded-lg mt-4 md:mt-4">Call Now for Emergency Repair</Link>
        </div>
        <div className="sep-line flex justify-center ">
          <div className="w-full md:w-[50vw] h-[2px] bg-[var(--primary)] my-8 md:my-16"></div>
        </div>
