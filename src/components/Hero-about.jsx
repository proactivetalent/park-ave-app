...
const HeroAbout = () => {
  return (
    <div>
      <div className="flex flex-col md:flex-row justify-center items-center gap-6 md:gap-20 lg:gap-44 md:pt-30 hero h-[100vh] bg-[url('/src/assets/about/hero-about.png')] bg-cover bg-center bg-no-repeat m-0 p-0 relative before:content-[''] before:absolute before:inset-0 px-4 md:px-0">
