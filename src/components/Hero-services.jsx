...
const HeroServices = () => {
    return (
        <div>
            <div className="flex justify-center gap-6 md:gap-44 md:pt-30 items-center hero h-[100vh] bg-[url('/assets/service/hero-services.png')] bg-cover bg-center bg-no-repeat m-0 p-0 relative before:content-[''] before:absolute before:inset-0">
