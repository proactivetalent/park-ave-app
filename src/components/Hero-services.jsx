...
const HeroServices = () => {
    return (
        <div>
            <div className="flex justify-center gap-6 md:gap-44 md:pt-30 items-center hero h-[100vh] bg-[url('/src/assets/service/hero-services.png')] bg-cover bg-center bg-no-repeat m-0 p-0 relative before:content-[''] before:absolute before:inset-0">
                <div className="flex flex-col items-center text relative z-10 text-white font-medium text-sm md:text-lg">
                    ...
                    <Link to="/contact" className="inline-flex items-center bg-white font-bold text-[var(--primary)] border-0 py-2 px-6 md:px-9 focus:outline-none hover:bg-gray-300 rounded-lg text-base sm:text-xl md:text-[24px] mt-6 md:mt-6">GET YOUR FREE QUOTE</Link>
                </div>
            </div>
        </div>
    )
