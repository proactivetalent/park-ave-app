...
const Hero = () => {
    return (
        <div>
            <div className="flex flex-col md:flex-row justify-center overflow-hidden gap-6 md:gap-10 pt-10 md:pt-50 items-center hero h-[100vh] min-h-[600px] bg-[url('/assets/home/hero.png')] bg-cover bg-center bg-no-repeat m-0 p-0 relative before:content-[''] before:absolute before:inset-0 min-w-[100%]">
                <div className="img relative z-10 flex flex-col items-center md:items-start w-full md:w-auto mb-6 md:mb-0">
                    <img className="relative z-10 w-48 md:w-md 2xl:w-lg bottom-0 " src="/assets/home/hero-img.png" alt="" />
                </div>
