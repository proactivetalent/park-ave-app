...
const Main = () => {
    return (
        <div className="intro w-full max-w-6xl px-4 sm:px-6 md:px-8 flex flex-col justify-center items-center m-auto">
            <h1 className='text-2xl sm:text-3xl md:text-4xl 2xl:text-5xl font-bold w-full md:w-xl 2xl:w-2xl text-[var(--primary)] pt-10 md:pt-20 text-center'>EXPERT SOLUTIONS FOR NYC'S ELECTRICAL NEEDS</h1>

            <div className="sep-line flex justify-center">
                <div className="w-full sm:w-[80vw] md:w-[35vw] h-[4px] bg-[var(--primary)] my-8 md:my-16"></div>
            </div>
            ...
            <div className="f1 flex flex-col md:flex-row justify-evenly gap-6 md:gap-10 mb-10 w-full">
                <div className="right md:w-1/2 flex flex-col justify-center items-start">
                    <h1 className='text-xl sm:text-2xl md:text-4xl 2xl:text-5xl font-bold w-full md:w-96 text-[var(--primary)] mb-2 uppercase'>Electrical Renovations</h1>
                ...
                <div className="left relative md:w-1/2 flex justify-center items-center mt-4 md:mt-0">
                    <img className="w-full max-w-xs md:max-w-md" src="/src/assets/home/f1.png" alt="" />
                </div>
            </div>
            ...
            <div className="f2 flex flex-col md:flex-row justify-evenly gap-6 md:gap-10 mb-10 w-full">
                <div className="left relative md:w-1/2 flex justify-center items-center mb-4 md:mb-0">
                    <img className="w-full max-w-xs md:max-w-md" src="/src/assets/home/f2.png" alt="" />
                </div>
                <div className="right md:w-1/2 flex flex-col justify-center items-start">
                    <h1 className='text-xl sm:text-2xl md:text-4xl 2xl:text-5xl font-bold w-full md:w-96 text-[var(--primary)] mb-2 capitalize'>Installations & upgrades</h1>
            ...
            <div className="f3 flex flex-col md:flex-row justify-evenly gap-6 md:gap-10 mb-10 w-full">
                <div className="right md:w-1/2 flex flex-col justify-center items-start">
                    <h1 className='text-xl sm:text-2xl md:text-4xl 2xl:text-5xl font-bold w-full md:w-96 text-[var(--primary)] mb-2 capitalize'>Safety & Code Compliance</h1>
                ...
                <div className="left relative md:w-1/2 flex justify-center items-center mt-4 md:mt-0">
                    <img className="w-full max-w-xs md:max-w-md" src="/src/assets/home/f3.png" alt="" />
                </div>
            </div>
            ...
            <div className="f4 flex flex-col md:flex-row justify-evenly gap-6 md:gap-10 mb-10 w-full">
                <div className="left relative md:w-1/2 flex justify-center items-center mb-4 md:mb-0">
                    <img className="w-full max-w-xs md:max-w-md" src="/src/assets/home/f4.png" alt="" />
                </div>
                <div className="right md:w-1/2 flex flex-col justify-center items-start">
                    <h1 className='text-xl sm:text-2xl md:text-4xl 2xl:text-5xl font-bold w-full md:w-96 text-[var(--primary)] mb-2'>TROUBLESHOOTING & REPAIRS</h1>
