            ...
            <div className="electrical flex flex-col md:flex-row w-full md:w-[80vw] m-auto mt-10 px-4">
                ...
                <div className="desc w-full md:w-[50vw] flex flex-col justify-center">
                    <div className="heading mt-8 md:mt-20">
                        <h1 className='text-2xl sm:text-3xl md:text-[48px] font-extrabold text-[#C80003]'>What We Offer</h1>
                        <div className="sep-line flex justify-start ">
                            <div className="w-1/2 md:w-[20vw] h-[4px] bg-[#C80003]"></div>
                        </div>
                        <h2 className='text-xl sm:text-2xl md:text-[40px] font-extrabold text-[#C80003] mt-4'>Electrical Renovations</h2>
                    ...
                    <div className="features mt-8 md:mt-12">
                        <ol className='list-none space-y-4'>
                            <li className='flex items-start gap-2'>
                                <img className='w-5 mt-1' src="src/assets/bullet-point.svg" alt="" />
                                <span className='text-base sm:text-lg md:text-[20px] font-semibold'><span className='font-bold italic text-[#C80003]'>Kitchen Remodels:</span> GFCI circuits for appliances, under-cabinet lighting, and dedicated outlets</span></li>
                            <li className='flex items-start gap-2'>
                                <img className='w-5 mt-1' src="src/assets/bullet-point.svg" alt="" />
                                <span className='text-base sm:text-lg md:text-[20px] font-semibold'><span className='font-bold italic text-[#C80003]'>Bathroom Renovations:</span> Waterproof fixtures, heated floor wiring, and ventilation systems</span></li>
                            <li className='flex items-start gap-2'>
                                <img className='w-5 mt-1' src="src/assets/bullet-point.svg" alt="" />
                                <span className='text-base sm:text-lg md:text-[20px] font-semibold'><span className='font-bold italic text-[#C80003]'>Historic Home Upgrades:</span> Knob-and-tube replacement meeting Landmarks Preservation standards</span></li>
                            <li className='flex items-start gap-2'>
                                <img className='w-5 mt-1' src="src/assets/bullet-point.svg" alt="" />
                                <span className='text-base sm:text-lg md:text-[20px] font-semibold'><span className='font-bold italic text-[#C80003]'>Whole-Home Rewiring:</span> Aluminum/cloth-wire remediation for pre-war buildings</span></li>
                            <li className='flex items-start gap-2'>
                                <img className='w-5 mt-1' src="src/assets/bullet-point.svg" alt="" />
                                <span className='text-base sm:text-lg md:text-[20px] font-semibold'><span className='font-bold italic text-[#C80003]'>Basement Conversions:</span> Egress lighting and moisture-resistant installations</span></li>
                        </ol>
                        <p className='mt-5 text-base sm:text-lg md:text-[20px] font-semibold text-[#C80003]'>We navigate NTC's Unique plaster walls, co-op board requirements, and tight spaces with precision</p>
                    </div>
                </div>
            </div>
            <div className="flex justify-center my-10 md:my-20 px-4">
                <Link to="/contact" className="w-full md:w-auto inline-flex items-center justify-center bg-[#C80003] font-bold text-lg md:text-[24px] text-white border-0 py-2 px-6 md:px-9 focus:outline-none hover:bg-red-900 rounded-lg mt-4 md:mt-4 text-center">Transform Your Space with Complimentary Consultation</Link>
            </div>

            <div className="installation w-full bg-[url('/src/assets/bg-services.png')] bg-cover bg-center bg-no-repeat m-0 p-0 relative before:content-[''] before:absolute before:inset-0">
