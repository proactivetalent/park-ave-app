...
const MainServices = () => {
    return (
        <div className='w-full'>
            ...
            <div className="installation w-full bg-[url('/src/assets/service/bg-services.png')] bg-cover bg-center bg-no-repeat m-0 p-0 relative before:content-[''] before:absolute before:inset-0">
