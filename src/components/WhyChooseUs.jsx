        ...
        <div className="grid-container grid grid-cols-1 md:grid-cols-2 grid-rows-6 md:grid-rows-3 w-full overflow-hidden">
          <div className="border-b md:border-r border-gray-400 p-4 flex items-center">
            <div className="g1 flex flex-col pl-0 md:pl-10">
              ...
              <div className="head flex items-start gap-3">
                ...
                <span className='text-lg sm:text-2xl md:text-3xl font-bold text-[var(--primary)] mb-3'>Why Choose NYC-Specific Expertise</span>
              </div>
          ...
          <div className="border-b border-gray-400 p-4 flex items-center">
            <div className="g2 flex flex-col pl-0 md:pl-10">
              ...
              <div className="head flex items-start gap-3">
                <img className='w-4 md:w-7 mt-1' src="src/assets/svgs/bullet-point.svg" alt="" />
                <span className='text-lg sm:text-2xl md:text-3xl font-bold text-[var(--primary)] mb-3'>Safety-First Philosophy</span>
              </div>
          ...
          <div className="border-b md:border-b border-gray-400 md:border-r p-4 flex items-center">
            <div className="g3 flex flex-col pl-0 md:pl-10">
              ...
              <div className="head flex items-start gap-3">
                <img className='w-4 md:w-7 mt-1' src="src/assets/svgs/bullet-point.svg" alt="" />
                <span className='text-lg sm:text-2xl md:text-3xl font-bold text-[var(--primary)] mb-3'>Craftsmanship Guarantee</span>
              </div>
          ...
          <div className="border-b border-gray-400 p-4 flex items-center">
            <div className="g4 flex flex-col pl-0 md:pl-10">
              ...
              <div className="head flex items-start gap-3">
                <img className='w-4 md:w-7 mt-1' src="src/assets/svgs/bullet-point.svg" alt="" />
                <span className='text-lg sm:text-2xl md:text-3xl font-bold text-[var(--primary)] mb-3'>Respect for Your Time</span>
              </div>
          ...
          <div className="md:border-r border-gray-400 p-4 flex items-center">
            <div className="g5 flex flex-col pl-0 md:pl-10">
              ...
              <div className="head flex items-start gap-3">
                <img className='w-4 md:w-7 mt-1' src="src/assets/svgs/bullet-point.svg" alt="" />
                <span className='text-lg sm:text-2xl md:text-3xl font-bold text-[var(--primary)] mb-3'>Spotless Worksite Policy</span>
              </div>
          ...
          <div className="p-4 flex items-center">
            <div className="g6 flex flex-col pl-0 md:pl-10">
              ...
              <div className="head flex items-start gap-3">
                <img className='w-4 md:w-7 mt-1' src="src/assets/svgs/bullet-point.svg" alt="" />
                <span className='text-lg sm:text-2xl md:text-3xl font-bold text-[var(--primary)] mb-3'>24/7 Emergency Response</span>
              </div>
